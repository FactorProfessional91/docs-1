...
`),As,n(`
`),Cs,n(`
`),ms])]),s("pre",Ts,[s("code",null,[bs,n(`
`),ws,n(`
`),ks,n(`
`),s("span",gs,[s("span",qs,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),Ds,n(`
...
`),Hs,n(`
`),s("span",Xs,[s("span",Js,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`

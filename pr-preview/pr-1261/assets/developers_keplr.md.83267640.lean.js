...
`),O,n(`
`),j,n(`
`),G])]),s("pre",H,[s("code",null,[Q,n(`
`),W,n(`
`),J,n(`
`),s("span",X,[s("span",Y,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),L,n(`
`),s("span",z,[s("span",Z,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
